        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <a
              href={SITE_CONFIG.links.github}
              target="_blank"
              className="group flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4 hover:border-slate-300"
            >
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <h3 className="mb-2 text-xl font-semibold text-slate-900 transition-colors group-hover:text-sky-400">
                    {project.title}
                  </h3>
