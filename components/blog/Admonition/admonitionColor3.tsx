...
const OverviewAdmonition = ({ title, children }: AdmonitionProps) => {
  ...
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#4f46e5] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#a5b4fc]">
...
const NoteAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Note';
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#0284c7] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#38bdf8]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const ImportantAdmonition = ({ title, children }: AdmonitionProps) => {
  ...
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#b45309] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#f59e0b]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const TipAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Tip';
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#047857] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#34d399]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const WarningAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Warning';
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#be123c] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#fb7185]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const CommentAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Comment';
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#475569] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#a8b3c4]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const ExampleAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Example';
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#7e22ce] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#c084fc]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const QuoteAdmonition = ({ title, children }: AdmonitionProps) => {
  title = title || 'Quote';
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#0f766e] bg-[#0c1320] italic text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#5eead4]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const QuestionAdmonition = ({ title, children }: AdmonitionProps) => {
  ...
  return (
    <div className="my-3 rounded-xl border border-[#26354a] border-l-[3px] border-l-[#0e7490] bg-[#0c1320] text-[#d7dde8]">
      <div className="flex bg-[#111b2b] p-3 text-[#67e8f9]">
        <svg className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const SimpleAdmonition = ({ title, children }: AdmonitionProps) => {
  return (
    <div className="my-3 rounded-xl border border-[#304059] bg-[#0c1320] text-[#d7dde8]">
      {title && (
        <>
          <div className="flex bg-[#101927] p-3 text-[#d8e0eb]">
            {title}
          </div>
